...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rtd-poetry-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12474&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rtd-poetry-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rtd-poetry` can be installed with:

```
conda install rtd-poetry
```

It is possible to list all of the versions of `rtd-poetry` available on your platform with:
